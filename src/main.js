...
const configuration = {
  ...
  deprecation_date:
    "DEPRECATION_DATE" in process.env
      ? new Date(process.env.DEPRECATION_DATE)
      : undefined,
};
...
app.locals.deprecation_date = configuration.deprecation_date;
...
app.use(
  morgan("[:id] :remote-addr :method :url", {
    immediate: true,
